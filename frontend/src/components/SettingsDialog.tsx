        ...
        >
          ...
          <div className="divide-y divide-line rounded-xl border border-line">
            <div className="flex gap-3 p-4">
              <ShieldCheck className="mt-0.5 shrink-0 text-success" size={19} />
              <div>
            ...
            <div className="flex gap-3 p-4">
              <KeyRound className="mt-0.5 shrink-0 text-accent" size={19} />
              <div>
          ...
          <div className="rounded-xl border border-line p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-sm font-semibold">Usuń dane finansowe</h3>
                <p className="mt-1 text-sm leading-relaxed text-muted">
                  Usunie transakcje, grupy, klasyfikacje, reguły, kopie zapasowe
                  i pliki z folderu danych. Klucz API oraz wybrany motyw
                  pozostaną zapisane.
                </p>
                {confirming ? (
